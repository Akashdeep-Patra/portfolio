      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <h2 className="text-5xl font-black tracking-tighter mb-8">Let's Work Together</h2>
            
            <div className="space-y-6 text-neutral-700 max-w-lg">
              <p>
                Have a project in mind or want to inquire about collaborations? 
              ...
              <div className="pt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-white p-3 rounded-full hover:bg-neutral-200 transition-colors">
